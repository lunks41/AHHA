    ...
    public class BaseService : IBaseService
    {
        ...
        public UserGroupRightsViewModel ValidateScreen(Int16 companyId, Int16 ModuleId, Int32 TransactionId, Int32 userId)
        {
            ...
            try
            {
                ...
                var userGroupRightsViewModels = _repository.QuerySingleORDefaultAsync<UserGroupRightsViewModel>($"select GroupRights.ModuleId,GroupRights.TransactionId,GroupRights.IsRead,GroupRights.IsCreate,GroupRights.IsEdit,GroupRights.IsDelete,GroupRights.IsExport,GroupRights.IsPrint from AdmUserGroupRights GroupRights INNER Join AdmUser Auser on GroupRights.UserGroupId=Auser.UserGroupId inner join AdmUserRights UserRights on UserRights.UserId=AUser.UserId where UserRights.CompanyId={companyId} And UserRights.UserId= {userId}And GroupRights.ModuleId={ModuleId} And GroupRights.TransactionId={TransactionId}", parameters);
