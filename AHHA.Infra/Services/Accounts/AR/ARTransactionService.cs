...
namespace AHHA.Infra.Services.Accounts.AR
{
    public sealed class ARTransactionService : IARTransactionService
    {
        ...
        public async Task<IEnumerable<GetOutstandTransactionViewModel>> GetARTransactionListAsync(string RegId, Int16 CompanyId, GetTransactionViewModel getTransactionViewModel, Int16 UserId)
        {
            try
            {
