...
namespace AHHA.Infra.Services.Masters
{
    public sealed class AccountSetupCategoryService : IAccountSetupCategoryService
    {
        ...
        public async Task<M_AccountSetupCategory> GetAccountSetupCategoryByIdAsync(Int16 CompanyId, Int16 AccSetupCategoryId, Int32 UserId)
        {
            try
            {
                var result = await _repository.GetQuerySingleOrDefaultAsync<M_AccountSetupCategory>($"SELECT AccSetupCategoryId,AccSetupCategoryCode,AccSetupCategoryName,CompanyId,Remarks,IsActive,CreateById,CreateDate,EditById,EditDate FROM dbo.M_AccountSetupCategory WHERE AccSetupCategoryId={AccSetupCategoryId}");
        ...
        public async Task<SqlResponce> AddAccountSetupCategoryAsync(Int16 CompanyId, M_AccountSetupCategory AccountSetupCategory, Int32 UserId)
        {
            bool isExist = false;
            ...
            using (var transaction = _context.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (!isExist)
                    {
                        ...
                        var sqlMissingResponce = await _repository.GetQuerySingleOrDefaultAsync<SqlResponceIds>("SELECT ISNULL((SELECT TOP 1 (AccSetupCategoryId + 1) FROM dbo.M_AccountSetupCategory WHERE (AccSetupCategoryId + 1) NOT IN (SELECT AccSetupCategoryId FROM dbo.M_AccountSetupCategory)),1) AS MissId");
        ...
        public async Task<SqlResponce> UpdateAccountSetupCategoryAsync(Int16 CompanyId, M_AccountSetupCategory AccountSetupCategory, Int32 UserId)
        {
        ...
        public async Task<SqlResponce> DeleteAccountSetupCategoryAsync(Int16 CompanyId, M_AccountSetupCategory AccountSetupCategory, Int32 UserId)
        {
            var sqlResponce = new SqlResponce();
            try
            {
