...
namespace AHHA.Infra.Services.Masters
{
    public sealed class TaxCategoryService : ITaxCategoryService
    {
        ...
        public async Task<M_TaxCategory> GetTaxCategoryByIdAsync(Int16 CompanyId, Int16 TaxCategoryId, Int32 UserId)
        {
            try
            {
        ...
        public async Task<SqlResponce> AddTaxCategoryAsync(Int16 CompanyId, M_TaxCategory TaxCategory, Int32 UserId)
        {
            bool isExist = false;
            ...
            using (var transaction = _context.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (!isExist)
                    {
                        ...
                        var sqlMissingResponce = await _repository.GetQuerySingleOrDefaultAsync<SqlResponceIds>("SELECT ISNULL((SELECT TOP 1 (TaxCategoryId + 1) FROM dbo.M_TaxCategory WHERE (TaxCategoryId + 1) NOT IN (SELECT TaxCategoryId FROM dbo.M_TaxCategory)),1) AS MissId");
        ...
        public async Task<SqlResponce> UpdateTaxCategoryAsync(Int16 CompanyId, M_TaxCategory TaxCategory, Int32 UserId)
        {
        ...
        public async Task<SqlResponce> DeleteTaxCategoryAsync(Int16 CompanyId, M_TaxCategory TaxCategory, Int32 UserId)
        {
            var sqlResponce = new SqlResponce();
            try
            {
