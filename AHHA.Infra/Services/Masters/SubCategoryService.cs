...
namespace AHHA.Infra.Services.Masters
{
    public sealed class SubCategoryService : ISubCategoryService
    {
        ...
        public async Task<M_SubCategory> GetSubCategoryByIdAsync(Int16 CompanyId, Int32 SubCategoryId, Int32 UserId)
        {
            try
            {
        ...
        public async Task<SqlResponce> AddSubCategoryAsync(Int16 CompanyId, M_SubCategory SubCategory, Int32 UserId)
        {
            bool isExist = false;
            ...
            using (var transaction = _context.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (!isExist)
                    {
                        ...
                        var sqlMissingResponce = await _repository.GetQuerySingleOrDefaultAsync<SqlResponceIds>("SELECT ISNULL((SELECT TOP 1 (SubCategoryId + 1) FROM dbo.M_SubCategory WHERE (SubCategoryId + 1) NOT IN (SELECT SubCategoryId FROM dbo.M_SubCategory)),1) AS MissId");
        ...
        public async Task<SqlResponce> UpdateSubCategoryAsync(Int16 CompanyId, M_SubCategory SubCategory, Int32 UserId)
        {
        ...
        public async Task<SqlResponce> DeleteSubCategoryAsync(Int16 CompanyId, M_SubCategory SubCategory, Int32 UserId)
        {
            var sqlResponce = new SqlResponce();
            try
            {
