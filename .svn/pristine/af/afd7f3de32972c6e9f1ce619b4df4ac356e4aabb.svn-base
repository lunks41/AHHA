...
namespace AHHA.Infra.Services.Accounts.AR
{
    public sealed class ARAdjustmentService : IARAdjustmentService
    {
        ...
        public ARAdjustmentService(IRepository<ArAdjustmentHd> repository, ApplicationDbContext context, IAccountService accountService)
        {
        ...
        public async Task<ARAdjustmentViewModelCount> GetARAdjustmentListAsync(string RegId, Int16 CompanyId, short pageSize, short pageNumber, string searchString, Int16 UserId)
        {
