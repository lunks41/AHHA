...
namespace AHHA.Application.IServices.Masters
{
    public interface IDocumentTypeService
    {
        ...
        public Task<SqlResponce> SaveDocumentTypeAsync(string RegId, Int16 CompanyId, M_DocumentType m_DocumentType, Int16 UserId);

        public Task<SqlResponce> DeleteDocumentTypeAsync(string RegId, Int16 CompanyId, DocumentTypeViewModel documentTypeViewModel, Int16 UserId);
    }
}