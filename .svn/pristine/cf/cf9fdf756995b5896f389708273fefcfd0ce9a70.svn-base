        ...
        public async Task<SqlResponce> SaveCBGeneralPaymentAsync(string RegId, Int16 CompanyId, CBGenPaymentHd CBGenPaymentHd, List<CBGenPaymentDt> CBGenPaymentDt, Int16 UserId)
        {
            ...
            try
            {
                using (var TScope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                {
                    ...
                    {
                        await _repository.GetQueryAsync<SqlResponceIds>(RegId, $"exec FIN_AR_CreateHistoryRec {CompanyId},{UserId},{CBGenPaymentHd.PaymentId},{(short)E_AR.Invoice}");
                    }
                    ...
                    if (SaveHeader > 0)
                    {
                        ...
                        if (SaveDetails > 0)
                        {
                            ...
                            await _repository.GetQueryAsync<SqlResponceIds>(RegId, $"exec FIN_AR_CreateStatement {CompanyId},{UserId},{CBGenPaymentHd.PaymentId},{(short)E_AR.Invoice}");
