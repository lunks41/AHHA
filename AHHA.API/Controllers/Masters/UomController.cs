    ...
    : base(memoryCache, mapper, baseServices)
        ...
        public async Task<ActionResult> GetAllUom()
        {
            try
            {
                ...
                {
                    var userGroupRight = ValidateScreen(CompanyId, (Int16)Modules.Master, (Int32)Master.Uom, UserId);
                    ...
                    if (userGroupRight != null)
                    {
                        ...
                        else
                        {
                            ...
                            cacheData = await _UomService.GetUomListAsync(CompanyId, pageSize, pageNumber, searchString.Trim(), UserId);
            ...
            try
            {
                ...
                if (ValidateHeaders(CompanyId, UserId))
                {
                    ...
                    if (userGroupRight != null)
                    {
                        ...
                        {
                            UomViewModel = _mapper.Map<UomViewModel>(await _UomService.GetUomByIdAsync(CompanyId, UomId, UserId));
                ...
                if (ValidateHeaders(CompanyId, UserId))
                {
                    ...
                    if (userGroupRight != null)
                    {
                        if (userGroupRight.IsCreate)
                        {
                            ...
                            var createdUom = await _UomService.AddUomAsync(CompanyId, UomEntity, UserId);
                ...
                if (ValidateHeaders(CompanyId, UserId))
                {
                    ...
                    if (userGroupRight != null)
                    {
                        if (userGroupRight.IsEdit)
                        {
                            ...
                            {
                                var UomToUpdate = await _UomService.GetUomByIdAsync(CompanyId, UomId, UserId);
                            ...
                            var sqlResponce = await _UomService.UpdateUomAsync(CompanyId, UomEntity, UserId);
            ...
            try
            {
                ...
                if (ValidateHeaders(CompanyId, UserId))
                {
                    ...
                    if (userGroupRight != null)
                    {
                        ...
                        {
                            var UomToDelete = await _UomService.GetUomByIdAsync(CompanyId, UomId, UserId);

                            if (UomToDelete == null)
                                return NotFound($"M_Uom with Id = {UomId} not found");

                            var sqlResponce = await _UomService.DeleteUomAsync(CompanyId, UomToDelete, UserId);
