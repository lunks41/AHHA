    ...
    : base(memoryCache, mapper, baseServices)
        ...
        public async Task<ActionResult> GetAllPort()
        {
            try
            {
                ...
                {
                    var userGroupRight = ValidateScreen(CompanyId, (Int16)Modules.Master, (Int32)Master.Port, UserId);
                    ...
                    if (userGroupRight != null)
                    {
                        ...
                        else
                        {
                            ...
                            cacheData = await _PortService.GetPortListAsync(CompanyId, pageSize, pageNumber, searchString.Trim(), UserId);
            ...
            try
            {
                ...
                if (ValidateHeaders(CompanyId, UserId))
                {
                    ...
                    if (userGroupRight != null)
                    {
                        ...
                        {
                            PortViewModel = _mapper.Map<PortViewModel>(await _PortService.GetPortByIdAsync(CompanyId, PortId, UserId));
                ...
                if (ValidateHeaders(CompanyId, UserId))
                {
                    ...
                    if (userGroupRight != null)
                    {
                        if (userGroupRight.IsCreate)
                        {
                            ...
                            var createdPort = await _PortService.AddPortAsync(CompanyId, PortEntity, UserId);
                ...
                if (ValidateHeaders(CompanyId, UserId))
                {
                    ...
                    if (userGroupRight != null)
                    {
                        if (userGroupRight.IsEdit)
                        {
                            ...
                            {
                                var PortToUpdate = await _PortService.GetPortByIdAsync(CompanyId, PortId, UserId);
                            ...
                            var sqlResponce = await _PortService.UpdatePortAsync(CompanyId, PortEntity, UserId);
            ...
            try
            {
                ...
                if (ValidateHeaders(CompanyId, UserId))
                {
                    ...
                    if (userGroupRight != null)
                    {
                        ...
                        {
                            var PortToDelete = await _PortService.GetPortByIdAsync(CompanyId, PortId, UserId);

                            if (PortToDelete == null)
                                return NotFound($"M_Port with Id = {PortId} not found");

                            var sqlResponce = await _PortService.DeletePortAsync(CompanyId, PortToDelete, UserId);
